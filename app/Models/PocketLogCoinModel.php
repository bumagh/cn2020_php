...
class PocketLogCoinModel extends Model
{
    protected $table      = 'pocket_log_coin';
    protected $primaryKey = 'id';
	protected $allowedFields = ['uid','tag','numb','memo','relid','adduid'];
	...
	public function setLog($tag,$uid,$numb,$memo='',$relid='',$adduid=''){
		...
		$adata['numb'] 		= $numb;
		$adata['memo'] 		= $memo;
		$adata['relid']		= empty($relid) ? $uid : $relid;
