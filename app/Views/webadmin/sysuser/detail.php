...
<form class="layui-form layui-form-pane" action="" id="form-<?=$init['tag']?>" lay-filter="form-<?=$init['tag']?>">
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-inline">
				  <input type="text" name="username" <?=((!empty($init['row']['uid']) && ($init['row']['rid']!=1)) ? "readonly style='background-color:#eee;' " : '')?> required  lay-verify="required" placeholder="请输入帐号" autocomplete="off" class="layui-input">
				</div>
			  </div>
			  <div class="layui-form-item">
